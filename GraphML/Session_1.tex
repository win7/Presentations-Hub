...
\author[Overview of Network Analysis]{Overview of Network Analysis}
    ...
    \begin{frame}{Motivation}
        \begin{figure}[htp!]
            ...
            \includegraphics[
                ...
                clip
            ]{pic/everything_is_connected.png}
...
\section{Practical Application}
    ...
    \begin{frame}{Implementations}
        \begin{itemize}
            ...
            \item Topics 
                \begin{itemize}
                    \item Control structures in \texttt{Python}
                    \item Data structures in \texttt{Python}
                \end{itemize}
            \item Lab
                \begin{itemize}
                    \item \href{https://drive.google.com/file/d/1vPC2-J5Uf5f_6e7py1p0x2tZSYaZkSXG/view?usp=sharing}{
...
\section{Planned Activity}
    \begin{frame}{Assignment for the next session}
        \begin{itemize}
            \item Research about social media ecosystem.
            \item Read the paper: Everything is Connected: Graph Neural Networks.
        \end{itemize}
...
\section*{References}
    ...
    \begin{frame}[allowframebreaks]
        \small % use this command to resize
        % \bibliography{ref}
