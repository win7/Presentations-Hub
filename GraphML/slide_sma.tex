...
\author[Introduction to Social Media Analytics]{Introduction to Social Media Analytics}
...
\institute [Sesión 1]{
    ...
    \hspace*{0.25cm}~%
    \includegraphics[width=3.0cm]{pic/logo_graph.png}
    \hspace*{0.25cm}~%
...
\section{Applications}
    ...
    \begin{frame}{Application in physic}
        ...
        \begin{figure}[ht!]
            \centering
            \includegraphics[width=0.8\linewidth]{pic/gns.png}
            \caption{GNS scheme.}
        \end{figure}
    \end{frame}
