...
\section{Graph machine learning}
    \subsection{Preliminaries}
        ...
        \begin{frame}{Basics of Neural networks (NN)}
            \begin{figure}
                \centering
                \animategraphics[width=0.5\textwidth,loop,autoplay]
                {10} % frame rate
    ...
    \subsection{Graph neural networks (GNNs)}
        ...
        \begin{frame}{Message passing mechanism}
            \alert{General GNN layer equation:}
    ...
    \subsection{More about embeddings}
        ...
        \begin{frame}{Example}
            \begin{columns}[t] % Option "c" centers vertically, while "t" aligns to the top.
                \begin{column}{0.5\textwidth}
                    Given the graph $G = (V, E)$ and the node embedding matrix $Z$, compute the edge-level embeddings: % the following node embedding matrix $Z \in \mathbb{R}^{5 \times 3}$:
        ...
        \begin{frame}{Example}
            \begin{columns}[t] % Option "c" centers vertically, while "t" aligns to the top.
                \begin{column}{0.5\textwidth}
                    Given the graph $G = (V, E)$ and the node embedding matrix $Z$, compute the graph-level embeddings: % the following node embedding matrix $Z \in \mathbb{R}^{5 \times 3}$:
        ...
        \begin{frame}{Practical example: node classification}
            \begin{itemize}
                \item Install requirements
                    \begin{itemize}
                        \item \texttt{Python}
                ...
                \item Lab
                    \begin{itemize}
                        \item \href{https://drive.google.com/file/d/12Ek4FL7PbQWjZnOkfpV4Mj30LafmrAkr/view?usp=sharing}{
                                \beamergotobutton{\faGoogle\ Open in Google Colab}
                            }
                    \end{itemize}
            \end{itemize}
...
\section{Applications}
    ...
    \begin{frame}{Application in recommender systems}
        ...
        \begin{figure}[ht!]
            \centering
            \includegraphics[width=0.75\linewidth]{../images/uber_model.png}
