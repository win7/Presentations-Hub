...
\section{Experiments}
    ...
    \begin{frame}{Dataset}
        Experiments using the following datasets: Leaf dataset (citar), Cacao daset.

        \begin{table}[htp!]
            \scriptsize
            \centering
            \caption{Cacao dataset.} % December
            % \label{tab:table1}
            \begin{tabular}{@{}lcrrrcr@{}}\toprule
                Group & Subgroup & \#Nodes  & \#Edges & Density & Is connected? & Node features (dim.) \\\midrule
                SecoAmazonas &	1 &	162	& 10268 &	0.787363 &	True &	signal intensity (3) \\
                SecoAmazonas &	2 &	162	& 8728 &	0.669274 &	True &	signal intensity (3) \\\midrule
                SecoSanMartin &	1 &	162	& 9771 &	0.749252 &	True &	signal intensity (3) \\
                SecoSanMartin &	2 &	162	& 9705 &	0.744191 &	True &	signal intensity (3) \\\midrule
                SecoCusco &	1 &	162	& 11297 &	0.866268& 	True &	signal intensity (3) \\
                SecoCusco &	2 &	162	& 8765 &	0.672111& 	True &	signal intensity (3) \\\midrule
                FrescoAmazonas &	1 &	162 &	9406 &	0.721264 &	True &	signal intensity (3) \\
                FrescoAmazonas &	2 &	162 &	9006 &	0.690591 &	True &	signal intensity (3) \\\midrule
                FrescoSanMartin &	1 &	162 &	9818 &	0.752856 &	True &	signal intensity (3) \\
                FrescoSanMartin &	2 &	162 &	9454 &	0.724944 &	True &	signal intensity (3) \\\midrule
                FrescoCusco &	1 &	162 &	10366 &	0.794878 &	True &	signal intensity (3) \\
                FrescoCusco &	2 &	162 &	9249 &	0.709225 &	True &	signal intensity (3) \\\bottomrule 
            \end{tabular}
        \end{table}
    ...
    \begin{frame}{Experiments setup}
        ...
        \begin{table}[htp!]
            ...
            \begin{tabular}{@{}ll@{}}\toprule
                ...
                Node embedding & 
                \texttt{VGAE}, \texttt{LVGAE}, \texttt{ARGVA}, \texttt{DGI} \\
                Positional encoding & Laplacian eigenvector PE, Random walk PE \\ % k=3, wlak_random=3
                Dimensions & 2, 3, 4, 8, 16, 32, 64, 128 \\ %, 256, 512 \\
                Optimizer & Adam with $lr=10^{-2}$, $weight\_decay=10^{-4}$ \\
                Early stopping & $patience=10$ \\
                Epochs & 100 \\\midrule
                Edge embedding & \texttt{Weighted-L2} \\\midrule
                Outliers detection & \texttt{COPOD} with ($contamination=0.1$) \\\midrule
                Dataset & Synthetic, Mutant, Leaf, Mentos \\
                Network variations & \textit{none} (0:0), \textit{one-to-one} (1:1), \textit{many-to-many} (m:m) \\\bottomrule
            \end{tabular}
        \end{table}
...
\section{Conclusions}
    Our proposal, called \texttt{GEMNA}, is a new approach to the exploratory analysis of metabolic networks.
    \begin{itemize}
