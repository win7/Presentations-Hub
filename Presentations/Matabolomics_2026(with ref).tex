...
\institute[JNU]{\footnotesize{\inst{1} Institute for Omics Sciences and Applied Biotechnology, Pontificia Universidad Católica del Perú} \\ \footnotesize{\inst{2} Department of Informatics, Universidad Nacional de San Antonio Abad del Cusco} \\ \footnotesize{\inst{3} German Cancer Research Center, Goethe University Frankfurt and German Cancer Consortium}}
...
\section{Introduction}
    ...
    \begin{frame}{Our objectives}
        Aligning metabolomic metworks for filter Mass spectrometry data via Graph Neural Network models.
...
\section{Results}
    \begin{frame}{Build metabolomic networks}
        \begin{table}[htp!]
            ...
            \begin{tabular}{@{}lcrrrcr@{}}\toprule
                ...
                DryAmazonas    &	2 &	162	& 4096 &	0.314010 &	True & \\\midrule
                DrySanMartin   &	1 &	162	& 3817 &	0.292692 &	True & \\
                DrySanMartin   &	2 &	162	& 3728 &	0.285868 &	True & \\\midrule
                DryCusco       &	1 &	162	& 4265 &	0.327045 & 	True & \\
                DryCusco       &	2 &	162	& 3348 &	0.256729 & 	True & \\\midrule
                FreshAmazonas  &	1 &	162 & 3749 &	0.287478 &	True & \\
                FreshAmazonas  &	2 &	162 & 3946 &	0.302584 &	False & \\\midrule
                FreshSanMartin &	1 &	162 & 3818 &	0.292769 &	True & \\
                FreshSanMartin &	2 &	162 & 3460 &	0.265317 &	True & \\\midrule
                FreshCusco     &	1 &	162 & 3600 &	0.276052 &	True & \\
                FreshCusco     &	2 &	162 & 3669 &	0.281343 &	True & \\\bottomrule 
            \end{tabular}
        \end{table}
    ...
    \begin{frame}{Node embedding (T-GAE)}
        \begin{figure}[htp!]
            ...
            \caption{Node embeddings (DryCusco).}
            % \source{Author, 2024.}
            % \label{fig:my_image}
        \end{figure}
