...
\section{Experiments}
    ...
    \begin{frame}{Dataset}
        ...
        \footnotetext[5]{\tiny{lvarez-Mamani, E., Buettner, F., Beltran-Castanon, C. A., \& Ibanez, A. J. (2024). Exploratory analysis of metabolic changes using mass spectrometry data and graph embeddings.}}
